 ...
 * @LastEditTime: 2019-10-06 01:06:13
  ...
  <div id="jzbox">
    ...
    <div id="container">
      ...
      <div class="shiftTips">
        ...
        <ul class="tips">
          <transition>
          <li class="tip tip1" v-bind="move()" :style='transform'><a href="###">关于最新城乡医保的分析通知</a></li>
          </transition>
          <transition>
          <li class="tip tip2" v-bind='move()' ><a href="###" >什么是五险一金</a></li>
          </transition>
        </ul>
      </div>
      <div class="colee"></div>
      ...
      <div class="serverList">
        ...
        <div class="meals-index">
          <div class="meal-index">
            <div class="meallist" >
              <div class="mealitem" style="width:10rem;" v-for='item in shebaodata' :key='item.title'>
...
let lb = [  require("../assets/img/lb1.png"),
...
export default {
  ...
  methods:{
    ...
    move:function(){
      ...
      // this.transform = {transform:'translateY(-2rem)'};
      setInterval(()=>{
        this.shiftNum -= 2;
